...
- [ ] T001a [P] Install shadcn/ui Select component: `npx shadcn@latest add select`
- [ ] T001b [P] Install shadcn/ui Textarea component: `npx shadcn@latest add textarea`
- [ ] T001c [P] Install shadcn/ui Avatar component: `npx shadcn@latest add avatar`

### Type and Config Updates

- [ ] T001 Add 'describe' to WorkflowStepId union type in src/types/index.ts
- [ ] T002 Add hasDescription to ArtifactManifest interface in src/types/index.ts
- [ ] T003 Add Describe step config with PenLine icon in src/config/workflowSteps.ts
- [ ] T004 [P] Add navPaneWidth and navPaneCollapsed to settingsStore in src/stores/settingsStore.ts
- [ ] T005 [P] Create descriptionStore with content, isDirty, loading states in src/stores/descriptionStore.ts
- [ ] T006 [P] Update workflowStore.updateContentStatus to include describe in src/stores/workflowStore.ts
...
- [ ] T007a [P] Write unit tests for save_description command in src-tauri/src/commands/description.rs
- [ ] T007b [P] Write unit tests for load_description command in src-tauri/src/commands/description.rs

### Implementation

- [ ] T007 Create description.rs with save_description command in src-tauri/src/commands/description.rs
- [ ] T008 Add load_description command to src-tauri/src/commands/description.rs
- [ ] T009 Register description commands in Tauri invoke_handler in src-tauri/src/lib.rs
- [ ] T010 Add saveDescription TypeScript wrapper in src/services/tauriCommands.ts
- [ ] T011 Add loadDescription TypeScript wrapper in src/services/tauriCommands.ts
- [ ] T012 Create useDescription hook with load/save/debounce logic in src/hooks/useDescription.ts
...
- [ ] T013 [US1] Create ProjectHeader component with uppercase name in src/components/layout/ProjectHeader.tsx
- [ ] T014 [US1] Refactor SpecSelector to use shadcn/ui Select component (remove native select)
- [ ] T015 [US1] Update NavPane to include ProjectHeader at top in src/components/layout/NavPane.tsx
- [ ] T016 [US1] Move SpecSelector from AppShell header into NavPane in src/components/layout/NavPane.tsx
- [ ] T017 [US1] Remove SpecSelector from AppShell header in src/components/layout/AppShell.tsx
...
- [ ] T018 [P] [US2] Create DescribeEditor component using shadcn/ui Textarea in src/components/workflow/DescribeEditor.tsx
- [ ] T019 [US2] Create DescribeStep component using DescribeEditor in src/components/workflow/DescribeStep.tsx
- [ ] T020 [US2] Add 'describe' case to DetailPane to render DescribeStep in src/components/layout/DetailPane.tsx
- [ ] T021 [US2] Wire DescribeStep to useDescription hook for load/save in src/components/workflow/DescribeStep.tsx
- [ ] T022 [US2] Update artifact scanning to detect description.md in src-tauri/src/commands/project.rs
- [ ] T022a [US2] Integrate description content as context input to Specify step execution (FR-008)
...
- [ ] T023 [US3] Create AvatarMenu component using shadcn/ui Avatar + DropdownMenu in src/components/layout/AvatarMenu.tsx
- [ ] T024 [US3] Add AvatarMenu to bottom of NavPane in src/components/layout/NavPane.tsx
- [ ] T025 [US3] Remove Settings button from AppShell header in src/components/layout/AppShell.tsx
- [ ] T026 [US3] Pass onSettings callback from NavPane to AvatarMenu for settings dialog
...
- [ ] T027 [US4] Add folder picker button to ProjectHeader in src/components/layout/ProjectHeader.tsx
- [ ] T028 [US4] Wire folder picker to existing handleOpenProject in AppShell
- [ ] T029 [US4] Pass onOpenProject callback from NavPane to ProjectHeader
...
- [ ] T030 [US5] Add new spec button with Plus icon to SpecSelector in src/components/layout/SpecSelector.tsx
- [ ] T031 [US5] Create create_spec Tauri command in src-tauri/src/commands/project.rs
- [ ] T032 [US5] Add createSpec TypeScript wrapper in src/services/tauriCommands.ts
- [ ] T033 [US5] Implement new spec dialog/prompt in SpecSelector component
- [ ] T034 [US5] Register create_spec command in Tauri invoke_handler in src-tauri/src/lib.rs
...
- [ ] T035 [US6] Install shadcn/ui Resizable component: `npx shadcn@latest add resizable`
- [ ] T036 [US6] Wrap AppShell layout in ResizablePanelGroup with horizontal direction
- [ ] T037 [US6] Convert NavPane to ResizablePanel with minSize/maxSize constraints
- [ ] T038 [US6] Implement collapsed icon rail state in NavPane with step icons and avatar
- [ ] T039 [US6] Add chevron toggle button to NavPane for collapse/expand
- [ ] T040 [US6] Wire onLayout callback to settingsStore for persistence
- [ ] T041 [US6] Add smooth CSS transition for collapse/expand animation
...
- [ ] T042 [US7] Add "Send to Terminal" button to DescribeEditor toolbar in src/components/workflow/DescribeEditor.tsx
- [ ] T043 [US7] Implement sendToTerminal function using writeTerminal in src/components/workflow/DescribeEditor.tsx
- [ ] T044 [US7] Add visual feedback (toast/badge) confirming text was sent
...
- [ ] T052 [P] Add tooltips for step icons in collapsed nav pane state
- [ ] T053 [P] Add "Log in to GitHub" option to AvatarMenu (placeholder for future)
- [ ] T054 [P] Handle edge case: no project loaded (show placeholder in ProjectHeader)
- [ ] T055 [P] Handle edge case: no specs in project (show "No specs" in dropdown)
